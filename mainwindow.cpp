    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(showAbout,&QAction::triggered,this,&MainWindow::showAbout_slot);
...
void MainWindow::showAbout_slot()
{
    emit signal_showAbout();
}
...
void MainWindow::on_btnShowOrHideList_clicked()
{
    ...
    else
    {
        ...
        ui->btnShowOrHideList->move(QPoint(10,10));
    }
}
